...
namespace WebApplication.Data
{
    public class Connection
    {
        ...
        public async Task sendLoginRequest(LoginInfo info)
        {
            ...
            {
                var wishlist = JsonConvert.DeserializeObject<List<UserWish>>(response.Content.ReadAsStringAsync().Result);
                Wishlist internwish = new Wishlist();
                internwish.wishlist = wishlist;
            }
        }
